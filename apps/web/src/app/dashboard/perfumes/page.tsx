...
import { Beaker, FlaskConical, Flower2, AlertTriangle, Plus, Shield, ShieldAlert, Download, Sparkles, Package, ArrowLeftRight, BarChart3, Star, CircleDot, Boxes, Search, Users, Settings, Smartphone, Brain, Plug2 } from 'lucide-react';
      ...
      <div className="flex items-center justify-between space-y-2">
        ...
        <div className="flex items-center space-x-2">
          <Button
            variant="outline"
            size="sm"
            onClick={() => window.location.href = '/dashboard/perfumes/search'}
          >
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => window.location.href = '/dashboard/perfumes/mobile'}
          >
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => window.location.href = '/dashboard/perfumes/integrations'}
          >
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => window.location.href = '/dashboard/perfumes/settings'}
          >
